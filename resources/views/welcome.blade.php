    ...
    <section class="py-4 text-center container">
      <div class="row py-lg-4">
        <div class="col-lg-6 col-md-3 mx-auto">
          <h1 class="fw-light">Todays world!</h1>
          <p class="lead text-body-secondary">Sometimes we blame others for our actions and some
            times we suffer for others mistake. Either one or the other, remember to feel in silence.</p>
        </div>
      </div>
    </section>
  ...
  <footer class="text-body-secondary py-5">
    <div class="container d-flex align-items-center justify-content-around">
      ...
      <p class="float-end mb-1">
        <a style="text-decoration: none;" href="#">Back to top</a>
      </p>
    </div>
  </footer>
